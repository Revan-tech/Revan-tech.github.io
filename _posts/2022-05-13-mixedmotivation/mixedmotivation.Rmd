...
Dzisiejszy wpis będzie taką mini motywacją do zainteresowania się mieszanymi modelami liniowymi (aka hierarhicznymi/wielopoziomowymi modelami mieszanymi). 
...
response_intercepts = rnorm(100,0, between_var) + between_effect * signal_intercepts

data =  data.frame()
for (participant in 1:100){
  
  signal = rnorm(100,4,0.1)  
  response =  within_effect*signal + rnorm(100,0,within_var)
...
Jak widzimy z wykresu, występuje zarówno efekt międzyobiektowy jak i wewnątrzobiektowy. Ponadto, te efekty mają przeciwny znak. 
...
Jeśli ktoś jest zainteresowany szczegółami, zarówno matematycznymi jak i bardziej praktycznymi, zachęcam do skorzystania z bazy wiedzy, gdzie znajdują się odnośnik do dobrych tutoriali i kursów omawiających tę klasę modeli. 
