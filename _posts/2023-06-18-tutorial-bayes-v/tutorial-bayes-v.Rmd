...
Prócz DIC, w statystyce Bayesowskiej narzedziami do oceny dopasowania modeli są: *Widely Applicable Information Criterion* (WAIC) i *Leave-one-out cross-validation* (LOO-CV). Są to metody, które nie są zaimplementowane w JAGS, niemniej ponieważ mają lepsze właściwości, warto je znać [@gelman2014understanding]. 
