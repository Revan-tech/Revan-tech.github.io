...
Prawdopodobieństwa $P(r_{i-1})$ i $P(v_{i-1})$ otrzymujemy poprzez "wycałkowanie niepotrzebnych parametrów" z prawdopodobieństwa *a posteriori* z poprzedniej próby $P(r_{i-1},v_{i-1},k|y_{i-1})$. 
