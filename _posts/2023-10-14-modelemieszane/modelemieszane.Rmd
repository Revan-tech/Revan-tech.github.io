...
Nas jednak interesuje to, czy osoby kiedy mają wyższą amplitudę sygnału dają też wyższą ocenę (efekt wewnątrzobiektowy). Możemy spróbować po prostu skorelować pojedyńcze pomiary pobudzenia i amplitudy ze sobą. Niestety ta metoda nie zadziałałaby. Dlaczego? Zasymulowałem takie dane:
